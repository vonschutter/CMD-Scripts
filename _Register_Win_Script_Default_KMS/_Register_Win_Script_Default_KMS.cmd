...
:: If the word auto is found in any of the switches passed to this script then use the 180 day trial activation.
@echo %1 %2 %3 %4 %5 %6 %7 %8 %9 |find /i "auto" && call :KMSActivation     & cls & endlocal & exit
echo:
echo:
echo:
echo:
